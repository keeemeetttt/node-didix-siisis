Bot_prefix = "s." #คำสั่งเวลายิง
#-------------------------------------------------
Bot_token = "OTk3Mjg2NTAxNzE1MDIxOTA1.GmsGMU.YyySw-nkwvhM3FYdFknVkZ9AzdQ6bV2Q5Y6iqk"  #ใส่ TOKEN BOT เรา
#-------------------------------------------------
Bot_MAXLIMIT = 10  #จำนวน
#-------------------------------------------------
Bot_LOCK = "1007110803058606151"  #ใส่DIห้องที่จะใช้คำสั่งบอท
#-------------------------------------------------
Bot_IMAGE1 = "https://media.discordapp.net/attachments/680449178626818065/909437371097972747/794404253744496642.gif"#ไม่เกี่ยว
Bot_IMAGE2 = "https://media.discordapp.net/attachments/965020828762767391/971991714061508658/standard_13.gif" #ใส่รูป
#-------------------------------------------------
Bot_STATS = "THE SHOP"  #สเตตัสม่วงเหมือนฉี่มึง
#-------------------------------------------------API
